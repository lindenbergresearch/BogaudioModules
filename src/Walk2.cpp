...
struct Walk2Display : TransparentWidget {
    ...
    Walk2Display(
        ...
        : _module(module), _size(size), _drawSize(2 * (_size.x - 2 * _insetAround), 2 * (_size.y - 2 * _insetAround)), _midX(_insetAround + _drawSize.x / 2), _midY(_insetAround + _drawSize.y / 2),
