...
struct PEQChannel {
    ...
    PEQChannel(
        ...
        : _filter(filter), _c(polyChannel), _levelParam(levelParam), _frequencyParam(frequencyParam), _frequencyCv1Param(frequencyCv1Param), _frequencyCv2Param(frequencyCv2Param),
          _bandwidthParam(bandwidthParam), _levelInput(levelCvInput), _frequency1Input(frequencyCv1Input), _frequency2Input(frequencyCv2Input), _bandwidthInput(bandwidthCvInput) {
