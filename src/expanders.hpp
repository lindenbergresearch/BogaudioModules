...
struct ChainableExpandableModule
    : ExpandableModule<MESSAGE, BASE>, ChainableRegistry<ELEMENT, N>::ChainableBase {
...
struct ChainableExpanderModule
    : ExpanderModule<MESSAGE, ExpandableModule<MESSAGE, BASE>>, ChainableRegistry<ELEMENT, N>::ChainableExpander {
    ChainableRegistry<ELEMENT, N> &_registry;
