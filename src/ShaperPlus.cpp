...
Model *modelShaperPlus = bogaudio::createModel<ShaperPlus, ShaperPlusWidget>(
    "Bogaudio-ShaperPlus", "SHAPER+", "Retro-inspired envelope generator and amplifier with additional CV", "Envelope generator", "VCA", "Polyphonic"
);
