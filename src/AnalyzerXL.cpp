...
struct AnalyzerXLWidget : AnalyzerBaseWidget {
    ...
    explicit AnalyzerXLWidget(AnalyzerXL *module) {
        ...
        auto signalaInputPosition = Vec(21.2, 62);
        auto signalbInputPosition = Vec(21.2, 110);
        auto signalcInputPosition = Vec(21.2, 158);
        auto signaldInputPosition = Vec(21.2, 206);

        addInput(createInputCentered<Port24>(signalaInputPosition, module, AnalyzerXL::SIGNALA_INPUT));
        addInput(createInputCentered<Port24>(signalbInputPosition, module, AnalyzerXL::SIGNALB_INPUT));
        addInput(createInputCentered<Port24>(signalcInputPosition, module, AnalyzerXL::SIGNALC_INPUT));
        addInput(createInputCentered<Port24>(signaldInputPosition, module, AnalyzerXL::SIGNALD_INPUT));

        addParam(createParamCentered<Knob26>(signalaInputPosition.plus(Vec(42.9, 3.8)), module, AnalyzerXL::CONTROLA_PARAM));
        addParam(createParamCentered<Knob26>(signalbInputPosition.plus(Vec(42.9, 3.8)), module, AnalyzerXL::CONTROLB_PARAM));
